...
-- MIGRATION: 20260815100000_consolidated_date_map_schedule_and_single_page_pdf.sql
-- SİPARİŞ TESLİMATI ATOMİK FİNANSAL İZOLASYONU VE TARİH BAZLI KONSOLİDASYON MİGRATİON
...
-- ----------------------------------------------------------------------------
-- 2. CREATE_SALE_TRANSACTION RPC PROSEDÜRÜ
--    Sadece siparişi oluşturur ve stok düşer. KESİNLİKLE customer_ledger VEYA payment_schedules KAYDI YAZMAZ!
-- ----------------------------------------------------------------------------
...
BEGIN
  ...
  -- KESİN KURAL: delivered_at IS NULL OLDUĞU SÜRECE CARİ BORÇ VE ÖDEME PLANI OLUŞTURULMAZ!
...
--    SADECE TESLİM EDİLDİĞİ ANDA CARİ BORÇ YAZILIR VE YENİ SATIŞIN 4 HAFTALIK TAKSİTLERİ YAZILIR
-- ----------------------------------------------------------------------------
...
BEGIN
  ...
  -- YENİ SATIŞ İÇİN 4 HAFTALIK TAKSİT PLANI YAZILMASI (TESLİMAT TARİHİNDEN BAŞLAR)
